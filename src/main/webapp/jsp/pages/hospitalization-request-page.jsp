...
<div class="container py-3">
    <div class="row flex-column align-items-center">
        <form method="POST" action="${pageContext.request.contextPath}/MentalHospital?command=hospitalization-request"
              class="flex-box col-md-6 h2">
            <h1 class="text-center text-primary font-weight-bold"><fmt:message key="hospitalization.request"/></h1>
            <div class="mb-4">
                ...
                <input class="date mt-1 form-control"
                       ...
                       name="dateIn" value="${date}" style="font-size: 2rem" required>
            </div>
