...
<div class="container py-3">
    <div class="row flex-column align-items-center">
        <form method="POST" action="${pageContext.request.contextPath}/MentalHospital?command=add-disease"
              class="flex-box col-md-6 h2">
            <h1 class="text-center text-primary font-weight-bold"><fmt:message key="navbar.add.disease"/></h1>
            <div class="mb-4">
                <span class="form-label"><fmt:message key="disease.add.name"/></span>
                <input type="text" name="name" minlength="4" maxlength="32" class="form-control mt-1" required
                       style="font-size: 2rem">
            </div>
            <div class="mb-4">
                <span class="form-label"><fmt:message key="disease.add.description"/></span>
                <input type="text" name="description" minlength="4" maxlength="3000" class="form-control mt-1" required
                       style="font-size: 2rem">
            </div>
